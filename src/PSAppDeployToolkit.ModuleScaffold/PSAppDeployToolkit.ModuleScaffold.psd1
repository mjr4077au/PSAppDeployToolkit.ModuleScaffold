#
# Module manifest for module 'PSAppDeployToolkit.ModuleScaffold'
#
...
@{
    ...
    RootModule = 'PSAppDeployToolkit.ModuleScaffold.psm1'
    ...
    GUID = '5f71f935-fc14-46e3-8ce3-3085b999266d'
